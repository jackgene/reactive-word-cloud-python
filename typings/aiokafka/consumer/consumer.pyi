...
class AIOKafkaConsumer:
    ...
    _closed = ...
    _source_traceback = ...
    def __init__(self, *topics, loop=..., bootstrap_servers=..., client_id=..., group_id=..., group_instance_id=..., key_deserializer=..., value_deserializer=..., fetch_max_wait_ms=..., fetch_max_bytes=..., fetch_min_bytes=..., max_partition_fetch_bytes=..., request_timeout_ms=..., retry_backoff_ms=..., auto_offset_reset=..., enable_auto_commit=..., auto_commit_interval_ms=..., check_crcs=..., metadata_max_age_ms=..., partition_assignment_strategy=..., max_poll_interval_ms=..., rebalance_timeout_ms=..., session_timeout_ms=..., heartbeat_interval_ms=..., consumer_timeout_ms=..., max_poll_records=..., ssl_context=..., security_protocol=..., api_version=..., exclude_internal_topics=..., connections_max_idle_ms=..., isolation_level=..., sasl_mechanism=..., sasl_plain_password=..., sasl_plain_username=..., sasl_kerberos_service_name=..., sasl_kerberos_domain_name=..., sasl_oauth_token_provider=...) -> None:
        ...
